...
describe('hmpoWarningText', () => {
    it('renders with text', () => {
        ...
        expect(cleanHtml($component)).to.equal('<span class="govuk-warning-text__assistive"></span>my text &lt;br&gt;');
    });
    ...
    it('renders with caller', () => {
        ...
        const $component = $('strong');
        expect(cleanHtml($component)).to.equal('<span class="govuk-warning-text__assistive"></span><br>caller text<br>');
    });
});
