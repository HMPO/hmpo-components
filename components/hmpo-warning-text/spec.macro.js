...
describe('hmpoWarningText', () => {
    it('renders with text', () => {
        ...
        expect(cleanHtml($component)).to.equal('<span class="govuk-visually-hidden">Warning</span>my text &lt;br&gt;');
    });
    ...
    it('renders with caller', () => {
        ...
        const $component = $('strong');
        expect(cleanHtml($component)).to.equal('<span class="govuk-visually-hidden">Warning</span><br>caller text<br>');
    });
});
