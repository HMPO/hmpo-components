...
describe('hmpoTextCount', () => {
    ...
    it('renders with max-words from validator', () => {
        ...
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', type: 'wordcount', maxwords: maxwords }, ctx: true }, locals);
    ...
    it('renders with max-characters from validator', () => {
        const maxchars = 5;
        locals.options.fields['my-input'].textAreaDescriptionText = 'sadhsahjashjv';
        locals.options.fields['my-input'].validate = [ { type: 'maxlength', arguments: maxchars } ];

        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', maxlength: maxchars }, ctx: true }, locals);
        const $component = $('.govuk-character-count__message');
        const countMessage = $component.text();

        expect(countMessage).to.contain(maxchars);
    ...
    it('renders label as header', () => {
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', isPageHeading: true }, ctx: true }, locals);
    ...
    it('renders with nopaste', () => {
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', isPageHeading: true, noPaste: true }, ctx: true }, locals);
        const $label = $('.govuk-textarea');

        expect($label.attr('class')).to.equal('govuk-textarea govuk-js-character-count govuk-!-width-one-half js-nopaste');
    });
    ...
    it('renders with no extra classes', () => {
        ...
        expect($label.attr('class')).to.equal('govuk-textarea govuk-js-character-count govuk-!-width-one-half');
    });

    it('renders with extra classes', () => {
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', isPageHeading: true, classes: 'test' }, ctx: true }, locals);
        const $label = $('.govuk-textarea');
    ...
    it('renders with extra classes and noPaste', () => {
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', isPageHeading: true, classes: 'test', noPaste: true }, ctx: true }, locals);
        const $label = $('.govuk-textarea');
    ...
    it('renders with noPaste set to false', () => {
        const $ = render({ component: 'hmpoTextCount', params: { id: 'my-input', isPageHeading: true, noPaste: false }, ctx: true }, locals);
        const $label = $('.govuk-textarea');
